...
fontawesome::fa_png(name = "r-project", file = "fig/r-project.png", fill = "blue")
...
2. Wrap the icon in anchor tags, `<a>`. For instance, here is an icon button to my github: <a href="https://github.com/leynu"><img src="https://github.com/leynu/Feb22_myfun/blob/master/fig/r-project.png?raw=true" alt="Leyla Nunez | Twitter" width="24px"/></a>
